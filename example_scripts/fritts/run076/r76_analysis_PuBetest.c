...
07220531_0810/ : no source, before north-side shield
07220608_1539/ : PuBe present (drum on floor). Only present for Dumps 1-13
07220608_1606/ : no source
...
char* ser[] = {"07220531_0810", "07220608_1539", "07220608_1606"} //<<<<<<
char* serlabel[] = {"no_source_partial_shield","PuBe","no_source"}
